...
document.addEventListener('DOMContentLoaded', () => {
    ...
    setTimeout(() => {
        ...
        $.ajax({
            ...
            url: 'https://www.googleapis.com/youtube/v3/search?part=snippet&channelId=UCU8p3fIw5Ibu5ECdFM5NmNQ&type=video&eventType=live&key=AIzaSyBoTz8gia7BA8ubZfaUoXrN1XhaniuM90w',
        ...
        $.ajax({
            ...
            url: 'https://www.googleapis.com/youtube/v3/search?part=snippet&channelId=DreamcasticChannel&type=video&eventType=live&key=AIzaSyBoTz8gia7BA8ubZfaUoXrN1XhaniuM90w',
            // We want our data back as a json object so we can traverse it for channel details.
            dataType: 'json',
            // This success variable is populated with our json data from the url.
            success: (response) => {
        ...
        $.ajax({
            ...
            url: 'https://www.googleapis.com/youtube/v3/search?part=snippet&channelId=UglyGoblinBoy&type=video&eventType=live&key=AIzaSyBoTz8gia7BA8ubZfaUoXrN1XhaniuM90w',
            // We want our data back as a json object so we can traverse it for channel details.
            dataType: 'json',
            // This success variable is populated with our json data from the url.
            success: (response) => {
